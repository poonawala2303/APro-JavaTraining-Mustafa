...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">HastiRoti Bank</a>
	...
	<header class="bg-success text-white text-center py-5">
        <div class="container">
            <h1>Welcome to HastiRoti Bank</h1>
    ...
    <section id="about" class="bg-secondary py-3">
    	<div class="container text-center text-white">
    		<h2>About us</h2>
    		
    		<div class="about">
    		
    			<p>HastiRoti Bank is a new generation private sector bank with 200 branches across India. It is a scheduled commercial bank regulated by the Reserve Bank of India. It is professionally managed and governed. HastiRoti Bank has contemporary technology and infrastructure including state of the art internet banking for personal as well as business banking customers.
    			</p>
    ...
    <footer class="bg-dark text-white text-center py-3">
    	<p>&copy; 2025 HastiRoti 	Bank. All Rights Reserved.</p>
    </footer>
