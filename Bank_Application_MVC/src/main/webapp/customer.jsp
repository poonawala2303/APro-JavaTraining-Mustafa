	...
	<section id="contact" class="flex-grow">
		<div class="container">
			...
			<div class="row">
				...
				<h2 class="text-center mb-3 mt-5">Customer Dashboard</h2>
				<h3 class="text-center mb-5">Customer Operations</h3>
				...
				<div class="col-md-6 mb-3 text-center">
					<button class="btn btn-primary btn-lg btn-block custom-btn">
